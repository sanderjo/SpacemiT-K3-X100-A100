...
So I used a certain tool to create a C program that does the same. See https://github.com/sanderjo/SpacemiT-K3-X100-A100/blob/main/to_ai_cores/to_ai_cores.c
