...
So I used a certain tool to create a C program that does the same. See https://github.com/sanderjo/SpacemiT-K3-X100-A100/blob/main/run_ai_cores/run_on_ai_cores.c
